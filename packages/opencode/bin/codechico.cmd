...
if defined CODECHICO_BIN_PATH (
    set "resolved=%CODECHICO_BIN_PATH%"
    goto :execute
)
...
set "name=codechico-!platform!-!arch!"
set "binary=codechico.exe"
...
:not_found
echo It seems that your package manager failed to install the right version of the codechico CLI for your platform. You can try manually installing the "%name%" package >&2
exit /b 1
