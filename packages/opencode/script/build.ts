...
for (const [os, arch] of targets) {
  ...
  await $`CGO_ENABLED=0 GOOS=${os} GOARCH=${GOARCH[arch]} go build -ldflags="-s -w -X main.Version=${Script.version}" -o ../opencode/dist/${name}/bin/tui ../tui/cmd/codechico/main.go`
    .cwd("../tui")
    .quiet()
